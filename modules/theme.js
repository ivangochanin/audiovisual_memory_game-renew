const theme = () => {
	...
	let indicatorWrapper = document.querySelectorAll('.indicatorWrapper');
	...
	let indicatorShadowLight = 'inset -3px -3px 6px rgba(255, 255, 255, 0.5), inset 3px 3px 3px rgba(210, 210, 211, 0.5)';
	let indicatorShadowDark = 'inset -3px -3px 6px rgba(57, 57, 57, 0.5), inset 3px 3px 3px rgb(28, 28, 29, 0.5)';
